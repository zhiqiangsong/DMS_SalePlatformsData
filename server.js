...
//var dealerSalesDataHandler = require('./api/handlers/dealerSalesDataHandler');
app.get('/jmapi/get-user-list.json',auth.adminOrbusinessCheck,commonHandler.getUserList);
app.post('/jmapi/add-edit-user.json',auth.adminOrbusinessCheck,commonHandler.addEditUser);
